    ...
    for dataset in datasets:
        ...
        if dataset == '2021-03-15-ab':  # temporaly because data is loaded there
            ...
            for key in chirp_keys:
                ...
                embed()
                chirp_savepath = '/home/localadmin/PycharmProjects/hilfloser_hiwi_project/saves/%s/%s' % (dataset, k_str)
                np.save(chirp_savepath + '/%s_chirp.npy' % k_str, zip(chirp_numbers, chirp_big_height, chirp_small_height))
                print('-------------------------------------')
